...
ActiveRecord::Schema[7.1].define(version: 2025_12_04_124925) do
  ...
  create_table "contadors", force: :cascade do |t|
    t.string "nombre"
    t.integer "valor"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "historico_pagos", force: :cascade do |t|
